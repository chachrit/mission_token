...
<div class="ds-dashboard-wrap">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 ds-page-inner">
        ...
        <?php if ($dataError): ?>
        <div class="mb-6 rounded-xl px-5 py-4 text-sm dsx-u001">
            <?= e($dataError) ?>
        </div>
        <?php endif; ?>
        ...
        <?php
            $progressPct = $monthlyTarget > 0
                ...
                : 0;
        ?>
        <section class="ds-id-card ds-anim dsx-u002">
        ...
        <div class="ds-quickstats-grid">
            ...
            <a href="<?= BASE_URL ?>/pages/challenges.php" class="ds-stat-card ds-anim ds-delay-12">
            ...
            <a href="<?= BASE_URL ?>/pages/rewards.php" class="ds-stat-card ds-anim ds-delay-20">
                <div class="ds-stat-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#dab937" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?= BASE_URL ?>/pages/history.php" class="ds-stat-card ds-anim ds-delay-28">
                <div class="ds-stat-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#dab937" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <section class="ds-quests-section ds-anim dsx-u003">
        ...
        <div id="dash-bottom-grid">
            ...
            <section class="ds-anim dsx-u004">
                <div class="ds-section-header">
                    <div class="ds-section-hd-left">
                        <div class="ds-section-bar"></div>
            ...
            <section class="ds-anim dsx-u005">
                <div class="ds-section-header dsx-u006">
                    <div class="ds-section-hd-left">
                        <div class="ds-section-bar"></div>
                ...
                <div class="ds-lb-card">
                    ...
                    <div class="ds-lb-row">
                        ...
                        <div class="ds-lb-bar-track">
                            <div class="ds-lb-bar-fill ds-lb-bar-fill--zero <?= $isMe ? 'ds-lb-bar-fill--me' : '' ?>" data-bar="<?= $barW ?>"></div>
                        </div>
                    </div>
                    <?php endforeach; ?>
                    <?php
