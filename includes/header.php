    ...
    <nav class="sticky top-0 z-50 nh-u001" id="main-nav">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <!-- Desktop Nav Links -->
                <div class="hidden lg:flex flex-1 min-w-0 items-center justify-center overflow-x-auto">
                    <?php
                ...
                <div id="nav-right" class="flex items-center gap-3">
                    ...
                    <!-- Mobile Hamburger -->
                                <button id="mobile-menu-btn" class="nav-mobile-menu-btn lg:hidden p-2 rounded-lg nh-u010"
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="hidden lg:hidden border-t nh-u016">
